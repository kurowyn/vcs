...
class City {
    private:
        ...
        f32 m_budget;
        i32 m_population;
        // But this might be better expressed using something other than a float, too.
...
class Event {
    ...
    // - negative (it benefits the inhabitants of the city, increasing the overall satisfaction level)
    // - positive (the opposite of the above). sometimes, the positive is used to mitigate the effects of
    // a negative event that has already occurred.
